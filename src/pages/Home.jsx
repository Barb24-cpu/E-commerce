  ...
  const [reviews] = useState([
    {
      ...
      role: "Verified Buyer",
      comment:
        "SokoPlus made sourcing items direct from sellers so simple. The protected payment system gave me total peace of mind.",
      rating: 5,
    },
    {
      id: 2,
      ...
      comment:
        "Listing my inventory here expanded my reach instantly. Safe, straightforward, and super reliable.",
      rating: 5,
    },
    {
      id: 3,
      ...
      comment:
        "Great customer service and transparent processes. Highly recommend SokoPlus to both buyers and sellers.",
      rating: 5,
    },
  ]);
        ...
        <section className="bg-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-6 pt-16 pb-20 text-center">
            ...
            <p className="max-w-2xl mx-auto text-lg text-gray-600 mb-8 leading-relaxed">
              Discover unique products from trusted independent sellers.
              Shop safely with protected payments and transparent
              transactions.
            </p>
