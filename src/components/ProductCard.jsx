...
function getStockInfo(stock) {
  ...
  if (stock === 1)
    return { label: "Only 1 left", color: "bg-orange-100 text-orange-700" };
  if (stock === 2)
    return { label: "Only 2 left", color: "bg-orange-100 text-orange-700" };
  if (stock === 3)
    return { label: "Only 3 left", color: "bg-yellow-100 text-yellow-700" };
  if (stock <= 10)
